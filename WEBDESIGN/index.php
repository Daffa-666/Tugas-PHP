...
<body>
  ...
  <div id="background">
    <div class="jumbotron">
      <p>Menjual Berbagai Macam Preset Lightroom</p>
    </div>
  </div>
  <!-- jumbotron -->
  ...
  <div id="home">
    <div class="isi">
      <div class="container atas">
        <h1>Best Seller Preset</h1>
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <i class="glyphicon glyphicon-map-marker"></i>
            <h3>Dark Moody</h3>
            <p class="text-justify"><strong>DarkMoody</strong>Preset yang mempunyai karakter Dark (gelap) dan menambahkan efek fokus ke tengah dan Preset ini digunakan di lokasi tertentu.</p>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <i class="glyphicon glyphicon-tree-conifer"></i>
            <h3>Dark Nature</h3>
            <p class="text-justify"><strong>DarkNature</strong>Preset yang mempunyai karakter Dark (gelap) namun Preset ini di peruntukkan untuk pepohonan atau alam.</p>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <i class="glyphicon glyphicon-camera"></i>
            <h3>Exotic Bright</h3>
            <p class="text-justify"><strong>ExoticBright</strong>Preset yang mempunyai karakter kecerahan yang exotic namun Preset ini di peruntukkan untuk tipe lensa camera yang intensitas cahaya nya sedikit.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <div class="thumbnail"><img src="assets/img/gambar-2-A.jpg">
           <div class="caption">
            <h3>Gambar 1</h3>
            <p class="text-justify">Foto ini diambil menggunakan kamera Smartphone berjenis Android sekitar pukul 06:25 WITA di desa Pinggan Kintamani,Bali. Dan foto ini menggunakan Preset Exotic Bright</p>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          ...
          <div class="caption">
            <h3>Gambar 2</h3>
            <p class="text-justify">Foto ini diambil menggunakan kamera Smartphone berjenis Android sekitar pukul 14:45 WITA di halaman rumah saya dan foto ini menggunakan preset Dark Moody</p>
            <button class="btn btn-default"tyoe="button">READ MORE</button>
          </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          ...
          <div class="caption">
            <h3>Gambar 3</h3>
            <p class="text-justify">Foto ini diambil menggunakan kamera Smartphone berjenis Android sekitar pukul 15:34 WITA di halaman rumah saya Dan foto ini menggunakan Preset Dark Moody</p>
            <button class="btn btn-default"tyoe="button">READ MORE</button>
          </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          ...
          <div class="caption">
            <h3>Gambar 4</h3>
            <p class="text-justify">Foto ini diambil menggunakan kamera Smartphone berjenis Android sekitar pukul 15:45 WITA di halaman rumah saya Dan foto ini menggunakan Preset Dark Nature</p>
            <button class="btn btn-default"tyoe="button">READ MORE</button>
          </div>
          </div>
        </div>
  ...
  <div id="about">
    <div class="container footer">
      ...
      <img src="./assets/img/logoo.png" width="180px">
        <h2>About Us</h2>
        <p> @_fxtrt                                                                                                            +62 81339 4587 69</p>
      </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
  ...
  <div id="kaki">
    <div class="container">
      <h5 class="text-center">FXTRT © 2021</h5>
    </div>
  </div>
  <!-- kaki -->
